...
class LinearRegressionModel:
    ...
    def model_term_significance_analysis(self, model_path, dont_plot_intercept=False, for_figure=False):
        ...
        print()
        print()
        print(f"estimated_variance_of_error_term for {response_variable}: {estimated_variance_of_error_term}")
        print("rss", rss)
        print("dof",dof)
        ...
        if for_figure:
            ...
            ax[0].set_ylabel("Input Variables", fontsize=fontsize)
        ...
        plt.savefig(model_path + "/Output/"+response_variable+"_model_terms_signficance.png")
        plt.savefig(model_path + "/Output/"+response_variable+"_model_terms_signficance.svg", format="svg")
        plt.clf()
